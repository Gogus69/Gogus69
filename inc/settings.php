...
final class Settings {
    ...
    public function __construct($connect = true) {
        ...
        $this->host = ''; #database ip
        $this->port = 3306; #database port. 3306 default database port

        $database = 's9_principal'; #database name

        $username = 'u9_6AbNRW9cUP'; #database username
        $password = 'RF=mOPo724f.np8pqjr1dvbW'; #database password

        // If you set a table prefix in config.yml, set it here as well
        $this->table_prefix = "lbanarchy_";
